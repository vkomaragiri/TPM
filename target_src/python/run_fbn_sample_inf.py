...
def write_PBS_script(path, bn_dir, mt_dir, ds, ev_dir, ev, results_dir, dist_dir):
    ...
    args = bn_dir+ds+'.fbn '+mt_dir+ds+'.mt '+ev_dir+ev+"/"+ds+'.evid'+' '+results_dir+'IMP_MT/'+ev+'/'+ds+'.PR '+results_dir+'LW/'+ev+'/'+ds+'.PR'
    command = dist_dir+program+'/'+program+' '+ args
...
def runExperiments():
    datasets = ['nltcs']#, 'msnbc', 'plants', 'baudio', 'jester', 'bnetflix', 'accidents', 'tretail', 'pumsb_star']#, 'dna', 'msweb', 'book', 'tmovie']
    #datasets = ['cwebkb', 'cr52', 'c20ng', 'bbc', 'ad']
    #datasets = ['BN_14']#,
    #datasets = ['BN_0']
    #datasets = ['BN_0',]
    #datasets = ['BN_0', 'BN_1', 'BN_2', 'BN_3', 'BN_4', 'BN_5', 'BN_6', 'BN_7', 'BN_8', 'BN_9', 'BN_10', 'BN_11', 'BN_12', 'BN_13', 'BN_14', 'BN_15', 'BN_28', 'BN_78', 'BN_94', 'BN_96', 'BN_98', 'BN_104', 'BN_106', 'BN_108', 'BN_110', 'BN_112', 'BN_114', 'BN_116', 'BN_118', 'BN_120', 'BN_122', 'BN_124']#, 'nltcs', 'msnbc', 'kdd', 'plants', 'baudio', 'jester', 'bnetflix', 'accidents', 'tretail', 'pumsb_star', 'dna', 'kosarek', 'msweb', 'tmovie', 'cwebkb', 'cr52', 'c20ng', 'bbc', 'ad', 'BN_100', 'BN_102']
    #datasets = ['grid', 'grid_extreme']
    #'book'

    bn_dir = r'/nfs/experiments/vasundhara/Proposals/learn_bn/models/NN/'
    mt_dir = r'/nfs/experiments/vasundhara/Proposals/learn_mt/models/MT/EM/'

    evid_dir = r'/nfs/experiments/vasundhara/Proposals/evid/FBN/NN/'
    results_dir = r'/nfs/experiments/vasundhara/Proposals/results/PR/FBN/NN/'
    dist_dir = r'/nfs/experiments/vasundhara/Proposals/dist/'

    evids = ['20', '50', '80']

    base_path = r'/nfs/experiments/vasundhara/Proposals/FBN_sample_inf_NN/'
