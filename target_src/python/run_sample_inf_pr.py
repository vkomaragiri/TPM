...
def write_PBS_script(path, bn_dir, mt_dir, ds, ev_dir, ev, results_dir, dist_dir):
    ...
    command = dist_dir+'sampleInfPR/'+program +' '+ args
...
def runExperiments():
    ...
    results_dir = r'/nfs/experiments/vasundhara/Proposals/results/PR/'
    dist_dir = r'/nfs/experiments/vasundhara/Proposals/dist/'

    evids = ['20', '50', '80']

    base_path = r'/nfs/experiments/vasundhara/Proposals/sample_inf_pr/'
