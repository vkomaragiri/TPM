...
resfilename = sys.argv[1].split("/")[-1]+".PR"
fprop = open(sys.argv[4]+"IMP_MT/"+ev+"/"+resfilename, "w")
flw1 = open(sys.argv[4]+"LW1/"+ev+"/"+resfilename, "w")
flw2 = open(sys.argv[4]+"LW2/"+ev+"/"+resfilename, "w")
