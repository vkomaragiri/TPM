...
data_directory = '/Users/vasundharakomaragiri/research/TMap.12.2020/TMap/results/oracle-uai-posterior-samples/'
...
for dataset in datasets:
    ...
    for i in range(len(evids)):
        ...
        for k in range(5):
            ...
            tpm = Y[k*len(ns):(k+1)*len(ns), 3]
            lw = Y[k*len(ns):(k+1)*len(ns), 4]
            l0 = axs[k, i].plot(ns, oracle_tpm, color = 'g', marker = 'o', markersize = 2, label='oracle-MCN')
            l1 = axs[k, i].plot(ns, tpm, color = 'r', marker = 'o', markersize = 2, label='MCN')
            l2 = axs[k, i].plot(ns, lw, color = 'b', marker = 'o', markersize = 2, label='LW')
    ...
    plt.savefig('/Users/vasundharakomaragiri/research/TMap.12.2020/TMap/python-code/plots/oracle-uai-posterior-samples/'+dataset+'.png', format='png')
#plt.show()
